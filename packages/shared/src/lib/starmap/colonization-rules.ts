...
export const COLONIZER_SHIP_CLASS_KEYS = {
  REBEL_TIER_1: 'REBEL_COLONIZER_ICARUS',
  EMPIRE_TIER_1: 'EMPIRE_COLONIZER_SENTINEL',
  REBEL_TIER_2: 'REBEL_COLONIZER_CR90',
  EMPIRE_TIER_2: 'EMPIRE_COLONIZER_LAMBDA_SETTLEMENT',
} as const;
