  ...
  return (
    <aside className="hidden md:flex fixed top-[52px] left-0 w-[68px] h-[calc(100vh-52px)] bg-swu-surface border-r border-swu-border flex-col items-center py-3 z-40">
      ...
      <div className="mt-auto pt-2 border-t border-swu-border/50 w-full flex flex-col items-center">
        <TickRing msToNext={tick.msToNext} tickIndex={tick.currentTickIndex} totalTicks={tick.totalTicks} />
      </div>
    </aside>
  );
}
...
function NavIconColonies() {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <circle cx="12" cy="12" r="9" /><path d="M12 3a15 15 0 0 1 0 18" /><path d="M12 3a15 15 0 0 0 0 18" /><path d="M3 12h18" />
    </svg>
  );
}
...
function NavIconShips() {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 2L4 20h16L12 2z" /><path d="M12 2v18" />
    </svg>
  );
}
...
function NavIconMap() {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <circle cx="12" cy="12" r="2" /><circle cx="12" cy="12" r="6" /><circle cx="12" cy="12" r="10" /><line x1="12" y1="2" x2="12" y2="4" /><line x1="12" y1="20" x2="12" y2="22" /><line x1="2" y1="12" x2="4" y2="12" /><line x1="20" y1="12" x2="22" y2="12" />
    </svg>
  );
}
...
function NavIconResearch() {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M9 3v12l-3 3h12l-3-3V3" /><path d="M9 3h6" /><circle cx="12" cy="17" r="1" />
    </svg>
  );
}
...
function TickRing({ msToNext, tickIndex, totalTicks }: { msToNext: number; tickIndex: number; totalTicks: number }) {
